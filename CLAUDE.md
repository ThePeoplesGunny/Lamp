...
**Graph:** 31,172 verse nodes (23,213 Hebrew + 7,927 Greek + 32 KJV-only slots) + 429 entities (293 persons, 25 nations, 111 places). 2,735 edges (249 entity-entity + 2,370 verse→entity MENTIONS + 116 NT→OT QUOTES).
...
- **(a) Expand QUOTES coverage** — swap the curated ~116 seed for STEPBible TAGNT (CC-BY) or equivalent to reach ~350+ edges. Then add `ALLUDES_TO` + `PARALLEL_TO` (Synoptic parallels, Kings↔Chronicles, Psalm parallels).
